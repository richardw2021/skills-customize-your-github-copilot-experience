---
description: "Use when creating or updating assignment README files under assignments so they follow the shared assignment template and project standards."
...
- Tasks: For each task:
  ...
  - In Requirements, use bullet points to list the expected outcomes or features.
  - Provide example input or output in code blocks if helpful.
